...
public class ExceptionHandlerAdvice {
    ...
    Result handleAccountException(AccountStatusException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "user account is abormal.", ex.getMessage());
    }
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "the access token provided is expired, revoked, or invalid for other reasons.", ex.getMessage());
    }
